    ...
    <div className='flex justify-center items-center min-h-screen bg-gray-100 p-4 '>
      <div className='w-full max-w-sm dark:bg-gray-800 dark:text-white bg-white rounded-lg shadow-lg p-6 m-4 dark:transition ease-in-out duration-500'>
       ...
       <a href='https://www.github.com/happyrao78'>
        <FaGithub className='text-3xl text-center flex mx-2 mt-3 mb-3 text-black dark:text-white' /></a>
        <a href='https://www.linkedin.com/in/happy-yadav-16b2a4287/'>
        <FaLinkedin className='text-3xl text-center flex mx-2 mt-3 mb-3 text-black dark:text-white' /></a>
        <a href='https://www.happyrao.tech'>
        <IoEarthOutline className='text-3xl text-center flex mx-2 mt-3 mb-3 text-black dark:text-white' /></a>
        </div>
